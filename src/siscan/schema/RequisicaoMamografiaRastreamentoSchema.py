...
class FezRadioterapiaNaMamaOuNoPlastrao(Enum):
    field_01 = '01'
    field_02 = '02'
    field_03 = '03'


class RadioterapiaLocalizacao(Enum):
    field_01 = '01'
    field_02 = '02'
    field_03 = '03'
    NoneType_None = None
...
class MamografiaDeRastreamento(Enum):
    field_01 = '01'
    field_02 = '02'
    field_03 = '03'
    NoneType_None = None
...
class RequisicaoMamografiaRastreamentoSchema(RequisicaoNovoExameSchema):
    ...
    radioterapia_localizacao: Annotated[
        Optional[RadioterapiaLocalizacao],
        Field(
    ...
    mamografia_de_rastreamento: Annotated[
        Optional[MamografiaDeRastreamento],
        Field(
    ...
    def valida_regras_condicionais(cls, values):
        ...
        if fez_radio != FezRadioterapiaNaMamaOuNoPlastrao.field_01 and loc:
            raise ValueError(
